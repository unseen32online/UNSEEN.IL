...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-cream-white border-b border-soft-gray">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/cart" className="relative cart-icon">
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-warm-sage text-cream-white text-xs font-medium w-5 h-5 flex items-center justify-center rounded-full">
                  {cartCount}
                </span>
              )}
            </Link>
